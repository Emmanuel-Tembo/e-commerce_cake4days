import { getProducts, getProductsByAudience } from '../model/Productsdb.js'
...
// New controllers for specific product types
export const getPetProductsCon = async (req, res) => {
    res.json({
        data: await getProductsByAudience('pet')
    })
}

export const getHumanProductsCon = async (req, res) => {
    res.json({
        data: await getProductsByAudience('human')
    })
}

export const getPodProductsCon = async (req, res) => {
    res.json({
        data: await getProductsByAudience('POD')
    })
}
